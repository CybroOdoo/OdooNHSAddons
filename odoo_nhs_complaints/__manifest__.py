...
#############################################################################
{
    ...
    'summary': 'Manage NHS complaints, PALS concerns, and compliance reporting.',
'description': """
Manage NHS PALS concerns, formal complaints, investigations,
KO41a reporting, and PHSO escalations in a single module.
Track complaint progress, resolutions, and compliance with
NHS complaint management processes.
""",
    'version': '19.0.1.0.0',
    ...
    'depends': ['odoo_nhs_incident_risk',],
    'data': [
