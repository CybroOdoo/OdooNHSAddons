...
class NhsComplaintInvestigation(models.Model):
    ...
    timeline_ids = fields.One2many('nhs.complaint.investigation.timeline', 'investigation_id',
                                   string='Chronology')
    ...
    action_ids = fields.One2many('nhs.action', 'complaint_investigation_id', string='Actions',
                                 help='Corrective/preventive actions arising from this investigation.')
    linked_incident_ids = fields.Many2many('nhs.incident', related='complaint_id.linked_incident_ids',
                                           readonly=False, string='Linked Incidents')
    linked_risk_ids = fields.Many2many('nhs.risk', related='complaint_id.linked_risk_ids',
                                       readonly=False, string='Linked Risks')
