...
class NhsDsptAction(models.Model):
    ...
    assertion_id = fields.Many2one(
        ...
        store=True,
        help="Assertion to which the originating evidence gap belongs."
    )
    ...
    priority = fields.Selection([
        ...
        ('medium', 'Medium'),
        ('high', 'High'),
    ], string='Priority', default='medium', help="Priority level of the improvement action.")
    ...
    state = fields.Selection([
        ...
        ('completed', 'Completed'),
        ('verified', 'Verified'),
    ], string='Status', required=True, default='open', tracking=True, help="Current status of the improvement action.")
    ...
    is_overdue = fields.Boolean(
        ...
        store=True,
        help="Indicates if target date has passed and action is not yet completed or verified."
    )
    ...
    def _reopen_wizard(self):
        """Reopens the action form view in a dialog window."""
        return {
