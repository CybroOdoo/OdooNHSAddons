...
class NhsDsptEdition(models.Model):
    ...
    assertion_count = fields.Integer(
        ...
        help="Total number of assertion definitions under this edition."
    )
    evidence_count = fields.Integer(
        string='Evidence Items',
        compute='_compute_counts',
        help="Total number of evidence definitions under this edition."
    )
    assessment_count = fields.Integer(
        string='Assessments',
        compute='_compute_counts',
        help="Total number of assessments created using this edition."
    )
    standard_count = fields.Integer(
        string='Standards Count',
        compute='_compute_standard_count',
        help="Total number of standards defined in this edition."
    )
    notes = fields.Text(
        string='Notes',
    ...
    active = fields.Boolean(
        string='Active',
        default=True,
        help="Indicates whether this edition record is active."
    )
