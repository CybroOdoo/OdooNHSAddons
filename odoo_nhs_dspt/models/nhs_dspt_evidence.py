...
class NhsDsptEvidence(models.Model):
    ...
    name = fields.Char(
        ...
        store=True,
        help="Name of the evidence item derived from its definition."
    )
    reference = fields.Char(
        string='Reference',
        related='evidence_def_id.reference',
        store=True,
        help="Reference code of the evidence item."
    )
    ...
    standard_id = fields.Many2one(
        ...
        store=True,
        help="Standard under which this evidence falls."
    )
    ...
    is_mandatory = fields.Boolean(
        ...
        store=True,
        help="Indicates if this evidence item is mandatory for compliance."
    )
    guidance = fields.Text(
        string='Guidance',
        related='evidence_def_id.guidance',
        help="Guidance notes for completing this evidence requirement."
    )
    ...
    status = fields.Selection([
        ...
        ('not_met', 'Not Met'),
        ('not_applicable', 'Not Applicable'),
    ], string='Status', required=True, default='not_started', tracking=True, help="Current status of this evidence requirement.")
    ...
    action_count = fields.Integer(
        ...
        help="Number of improvement actions raised for this evidence item."
    )
    ...
    company_id = fields.Many2one(
        ...
        store=True,
        help="Company associated with the parent assessment."
    )
    active = fields.Boolean(
        string='Active',
        default=True,
        help="Indicates whether this evidence record is active."
    )
