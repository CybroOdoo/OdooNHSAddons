...
class NhsDsptCarryForwardWizard(models.TransientModel):
    ...
    assessment_id = fields.Many2one(
        ...
        string='Assessment',
        required=True,
        help="Target assessment to receive carried-forward data."
    )
