...
#############################################################################
{
    ...
    'description': """NHS Incident & Risk Management,Datix Alternative,Risk Management, Incident Management,Datix,NHS,NHS Odoo, NHS Trust Management,
    Healthcare Risk Management, Healthcare Incident Management, UK Healthcare,NHS Backoffice, NHS Operations, NHS Governanceodoo, odoo nhs, odoo in nhs, odoo apps for nhs, nhs, ODOO NHS,""",
    'version': '19.0.1.0.0',
