...
class NhsNotificationRule(models.Model):
    ...
    def evaluate(self, incident):
        ...
        Runs as sudo: this is system automation triggered on incident create,
        and the triggering user (e.g. a Reporter) has no access to the rule
        config and no write access to the incident's compliance fields.
        """
        incident = incident.sudo()
